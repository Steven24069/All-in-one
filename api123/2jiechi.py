...
rizhi = os.path.join(script_dir, "rizhi", "jiechi.txt")
# API endpoints
...
#for domain in domains:
    ...
    # Parse create task response
        ...
        if create_data_id is None:
            print("pls check agian your key")
            continue
