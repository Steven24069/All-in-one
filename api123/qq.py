...
rizhi = os.path.join(script_dir, "rizhi", "qq.txt")
...
url = "https://api.boce.com/v3/task/create/qq"
...
def check_domains(log_file, normal_file, block_file, test_fail):
    with open(log_file, 'r') as file:
        lines = file.readlines()

    with open(normal_file, 'w') as file_1, open(block_file, 'w') as file_2, open(test_fail, 'w') as file_3 :
        for line in lines:
            line = line.strip()
...
check_domains(log_file, normal_file, block_file, test_fail )
...
#日志- logfile
with open(rizhi, 'a') as log,  open(normal_file, 'r') as file_1, open(block_file, 'r') as file_2, open(test_fail, 'r') as file_3:
    ...
    #log.write("-----拦截(非微信官方链接，需跳转访问) : \n")
    #log.write(file_4.read())




#count how many domain check
line_count = 0
with open(log_file, 'r') as file:
    for line in file:
        line_count +=1
